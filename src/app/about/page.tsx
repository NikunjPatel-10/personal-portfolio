  ...
  return (
    <section className="about-section container max-w-7xl mx-auto py-12 px-4 md:px-4 2xl:px-0">
      ...
      <motion.section className="bio-section mb-16" {...fadeInUp}>
        ...
        A passionate and results-driven Frontend Developer with a strong command of HTML, CSS, and JavaScript. Highly proficient in modern frameworks and libraries, including React, Next.js, and Angular, with hands-on experience building scalable and performant web applications.Always eager to adopt new technologies and best practices to stay ahead of the curve in the ever-evolving web development
        </p>
      </motion.section>
